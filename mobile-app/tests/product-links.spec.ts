...
test("quick tools keep core experiences inside the unified app", async ({ page }) => {
...
test("primary candidate no longer links core tools to recovered legacy pages", async ({ page }) => {
  await prepareHome(page);
