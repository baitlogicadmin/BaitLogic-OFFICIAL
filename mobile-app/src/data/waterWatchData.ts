...
export const waterWatchCheckedAt = "2026-09-19";
...
export const waterWatchItems: WaterWatchItem[] = [
  ...
  },
  {
    ...
    effectiveAt: "2027-01-01",
    sourceAuthority: "Illinois General Assembly",
    sourceUrl: "https://www.ilga.gov/legislation/BillStatus?DocNum=3917&DocTypeID=SB&GAID=18&LegId=167376&SessionID=114",
  ...
  },
  {
    ...
    status: "public-act",
    statusLabel: "Public Act 104-0838 · effective Aug 21, 2026",
    checkedAt: waterWatchCheckedAt,
    sourceAuthority: "Illinois General Assembly",
    sourceUrl: "https://www.ilga.gov/ftp/legislation/104/BillStatus/HTML/10400HB2955.html",
    fieldMeaning: "The enacted PFAS Wastewater Citizen Protection Act creates a PFAS Wastewater Citizen Protection Committee and PFAS Action Plan process.",
    guardrail: "The Act is now enacted; its effective date is August 21, 2026. Do not treat enactment as proof of PFAS contamination at a particular waterbody.",
    action: "Follow implementation through official Illinois records and waterbody-specific monitoring; keep local contamination claims tied to actual data.",
  },
  {
    id: "mute-swans",
