  ...
  return <div className="approved-dashboard">
    ...
    <main>
      ...
      <section className="pillar-grid">
        ...
        <a className="pillar conservation" href="/field-intel.html#conservation"><HeartIcon/><h2>CONSERVATION<br/>ACTION</h2><p>Report issues, protect habitat, and help keep our waters healthy.</p><span>MAKE A DIFFERENCE →</span></a>
      </section>
      ...
      <section className="lower-grid">
        ...
        <article className="impact-card">
          ...
          <a href="/field-intel.html#conservation">REPORT A CONCERN →</a>
        </article>
      </section>
